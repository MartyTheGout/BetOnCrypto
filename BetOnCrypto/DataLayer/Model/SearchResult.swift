...
struct MockedSearchResult {
    let coins : [SearchCoin]
    let nfts: [SearchNFT]
}

let mockedSearchResult = MockedSearchResult(coins: mockSearchCoin, nfts: mockSearchNFT )
...
struct SearchCoin {
    ...
    let thumb: String
    let large: String
    let data : SearchCoinData
}

struct SearchCoinData {
    let priceChangePercentage24h : ChangePercentageKRW
}

struct ChangePercentageKRW {
    let krw : Double
}
...
let mockSearchCoin: [SearchCoin] = [
    ...
    SearchCoin(
        ...
        data: SearchCoinData(priceChangePercentage24h: ChangePercentageKRW(krw: -4.00))
    ),
    ...
    SearchCoin(
        ...
        data: SearchCoinData(priceChangePercentage24h: ChangePercentageKRW(krw: -5.00))
    ),
    ...
    SearchCoin(
        ...
        data: SearchCoinData(priceChangePercentage24h: ChangePercentageKRW(krw: -6.00))
    ),
    ...
    SearchCoin(
        ...
        data: SearchCoinData(priceChangePercentage24h: ChangePercentageKRW(krw: -7.00))
    ),
    ...
    SearchCoin(
        ...
        data: SearchCoinData(priceChangePercentage24h: ChangePercentageKRW(krw: -8.00))
    ),
    ...
    SearchCoin(
        ...
        data: SearchCoinData(priceChangePercentage24h: ChangePercentageKRW(krw: -9.00))
    ...
    SearchCoin(
        ...
        data: SearchCoinData(priceChangePercentage24h: ChangePercentageKRW(krw: -10.00))
    ),
    ...
    SearchCoin(
        ...
        data: SearchCoinData(priceChangePercentage24h: ChangePercentageKRW(krw: -3.00))
    ),
    ...
    SearchCoin(
        ...
        data: SearchCoinData(priceChangePercentage24h: ChangePercentageKRW(krw: -2.00))
    ),
    ...
    SearchCoin(
        ...
        data: SearchCoinData(priceChangePercentage24h: ChangePercentageKRW(krw: -1.00))
    ),
    ...
    SearchCoin(
        ...
        data: SearchCoinData(priceChangePercentage24h: ChangePercentageKRW(krw: 0.00))
    ),
    ...
    SearchCoin(
        ...
        data: SearchCoinData(priceChangePercentage24h: ChangePercentageKRW(krw: 11.00))
    ),
]
